...
//        LoggerFactory.getLogger(target.getClass()).info(String.format("Response received: %s", returnValue));
//    }
//
//    @Override
//    public void before(Method method, Object[] args, Object target) throws Throwable {
//        LoggerFactory.getLogger(target.getClass()).info(String.format("Request sent: %s", args[0]));
//    }
//}
